                                 ...
                                 size_t tbslen)
{
  ...
  if (is_hybrid) {
    ...
    // This is a digestverify, this should not apply */
    /*
...
break;
    ...
    */
    ...
    // Max: Removed - the sign algorithm already carry the
    // MD algorithm
...
static int pkey_oqs_verifyctx(EVP_PKEY_CTX *ctx, const unsigned char *sig, int siglen,
  ...
  // Gets the tbs and tbslen values
  // from the digest - the digest_init should
  // initializes
  //
  // This seems wrong - should this be the mctx ?
  if (sig != NULL) {
