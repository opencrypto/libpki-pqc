...
openssl req -sha384 -new -key falcon.key -subj "/C=US/OU=Falcon512" -out ossl-falcon512-sha384.req
openssl req -new -key dilithium.key -subj "/C=US/OU=Dilithium2" -out ossl-dilithium2.req
openssl req -sha384 -new -key dilithium.key -subj "/C=US/OU=Dilithium2" -out ossl-dilithium2-sha384.req
...
openssl req -sha384 -new -key composite.key -subj "/C=US/OU=Composite One" -out ossl-composite-one.req
openssl req -new -key composite.key -subj "/C=US/OU=Composite Two" -out ossl-composite-two.req
openssl req -sha384 -new -key composite.key -subj "/C=US/OU=Composite Two" -out ossl-composite-two.req
